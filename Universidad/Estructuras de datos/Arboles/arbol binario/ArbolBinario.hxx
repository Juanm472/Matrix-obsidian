 ...
 * Explicacion: Implementa los métodos definidos en ArbolBinario.h.
 * Aquí se define cómo se realizan las operaciones de inserción, eliminación y los recorridos del árbol. 
 *
 * <><><><><><><><><><><><><><><><><><><><><><><><><><><><><><>
 */
